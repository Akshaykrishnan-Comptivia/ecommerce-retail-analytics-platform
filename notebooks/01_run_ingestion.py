...
if SETUP_KAGGLE:
    if KAGGLE_USERNAME and KAGGLE_KEY:
        ...
        print("WARNING: Kaggle credentials not configured.")
...
if not os.path.exists(config_path):
    raise FileNotFoundError(
        f"Config not found at {config_path} - required for public data downloads."
    )
...
try:
    ...
    print("Ensure you have READ VOLUME permission on the bronze raw_data volume.")
